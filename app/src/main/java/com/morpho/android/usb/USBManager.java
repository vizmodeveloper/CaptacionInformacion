...
public class USBManager {
	...
	public static String ACTION_USB_PERMISSION = "com.com.morpho.android.usb.USB_PERMISSION";
	...
	/**
	 * Get the device celular from given attributes
	 * 
	 * @param attribs
	 *            the USBDeviceAttributes object to check
	 * @return the device celular associated to the attributes
	 */
	public static synchronized String getDeviceModel(USBDeviceAttributes attribs) {
		...
		for (Entry<USBDeviceAttributes, String> entry : entrySet) {
			...
			// If attributes match, get the corresponding device celular
